...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <title>Relived Roleplay - UCP</title>
        ...
        <div class="container"><a class="navbar-brand" href="#"><img class="img-fluid" src="assets/img/icons/logo.png" alt="" /></a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="d-flex py-3 py-lg-0">
              <button type="button" class="btn btn-light rounded-pill shadow fw-bold" href="#" role="button">Login</button>
              <button type="button" class="btn btn-info rounded-pill shadow fw-bold mx-3" href="#" role="button">Register</button>
            </form>
          </div>
        </div>
      </nav>
      ...
      <section class="py-5">
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-5 col-lg-7 order-md-1 pt-8"><img class="img-fluid" src="assets/img/hero-header.png" alt="" /></div>
      ...
      <section class="py-6 pb-0">
        ...
        <div class="container">
          ...
          <div class="row py-7 justify-content-sm-between text-center text-md-start">
            <div class="col">
              <h1 class="fw-bold">Let's joining with us!</h1>
            </div>
            <div class="col text-lg-end"><a class="btn btn-lg btn-info rounded-pill me-4 me-md-3 me-lg-4" href="#" role="button">Register</a></div>
          </div>
          <div class="row justify-content-lg-around">
            ...
            <div class="col mb-3 order-3 order-sm-2">
              <h6 class="lh-lg fw-bold mb-4"> Usefull Links </h6>
              <ul class="list-unstyled mb-md-4 mb-lg-0">
                ...
                <li class="lh-lg"><a class="text-dark fs--1 text-decoration-none" href="https://ucp.relivedroleplay.com" target="_blank">UCP</a></li>
              </ul>
            </div>
